...
- TypeScript 5.x (SvelteKit frontend), TypeScript/Deno (Edge Functions) + @supabase/supabase-js ^2.98.0, SvelteKit 2.x (adapter-static), Tailwind CSS 4.x (005-supabase-auth)
- Supabase Postgres (existing `game_sessions`, `game_events` tables) + Supabase Auth (managed `auth.users`) (005-supabase-auth)
