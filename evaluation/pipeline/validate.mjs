...
// Exported so it can be unit-tested directly. Returns the set of schema names
// this validator accepts: "blueprint" plus every dimension whose
// <id>.schema.ts file exists on disk (kebab-case filename → underscore id).
export async function knownSchemaNames() {
...
// The block below is the CLI entry point. Guard it so importing this module
// (e.g. from a unit test) does not parse process.argv or call process.exit.
async function main() {
