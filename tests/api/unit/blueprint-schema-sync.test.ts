...
describe("blueprint schema sync", () => {
  ...
  // The age-profile mirror moved to tests/api/unit/shared-sync.test.ts, which
  // is driven by the MIRRORED_FILES manifest in scripts/sync-shared.mjs so new
  // mirrors are covered automatically.
});
